...
class WikisControllerTest < ActionController::TestCase
  ...
  test "should create wiki" do
    assert_difference('Wiki.count') do
      post :create, wiki: { description: @wiki.description, file: @wiki.file, name: @wiki.name, user_id: @wiki.user_id }
    end
  ...
  test "should update wiki" do
    patch :update, id: @wiki, wiki: { description: @wiki.description, file: @wiki.file, name: @wiki.name, user_id: @wiki.user_id }
    assert_redirected_to wiki_path(assigns(:wiki))
  end
